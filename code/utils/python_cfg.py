...
class PYTHON_CFG():
        ...
        for index, z in enumerate(node.children):
            ...
            if z.type == "compound_statement":
                ...
                if z.type == "block":
                    if index == len(node.children) - 1:
                        self.finlineno.append(z.end_point[0] + 1)
                        # self.finlineno1.append(z.end_point[0] + 1)
                    self.ast_visit(z)
    ...
    def visit_module(self, node):
        ...
        for index, z in enumerate(node.children):
            ...
            if z.type == "import_declaration":
                ...
                self.G.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
                # self.G.add_edge(z.end_point[0], z.end_point[0] + 1, weight=1)
                ...
                for j in z.children:
                    if j.type == "compound_statement":
                        ...
                        # self.DG.add_edge(j.end_point[0] + 1, node.start_point[0] + 1, weight=1)
                    elif j.type == "try":
    ...
    def visit_constructor_body(self, node):
        ...
        for index, z in enumerate(node.children):
            if z.type == "for_statement":
                ...
                self.G.add_edge(node.start_point[0] + 1, z.start_point[0] + 1, weight=1)
                    # self.DG.add_edge(node.start_point[0] + 1, z.start_point[0] + 1, weight=1)
                self.ast_visit(z)
            ...
            # 这里新加的
                ...
                self.G.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
                    # self.DG.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
            elif z.type == "{":
                self.G.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
                    # self.DG.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
            elif z.type == ";":
        ...
        if len(node.children) > 0 and node.children[0].type == "{":
            self.G.add_edge(node.children[0].start_point[0] + 1, node.children[0].start_point[0] + 2, weight=1)
                # self.DG.add_edge(node.children[0].start_point[0] + 1, node.children[0].start_point[0] + 2, weight=1)
        if len(node.children) > 0 and node.children[-1].type == "}":
            self.G.add_edge(node.children[-1].start_point[0], node.children[-1].start_point[0] + 1, weight=1)
                # self.DG.add_edge(node.children[-1].start_point[0], node.children[-1].start_point[0] + 1, weight=1)
    ...
    def visit_class_body(self,node):
        for index, z in enumerate(node.children):
            ...
            #     self.G.add_edge(z.start_point[0], z.start_point[0] + 1, weight=1)
            #     self.G.add_edge(z.start_point[0], z.start_point[0] + 2, weight=1)
            #     self.G.add_edge(z.start_point[0], z.start_point[0] + 3, weight=1)
            #     self.G.add_edge(z.start_point[0], z.start_point[0] + 4, weight=1)
    ...
    def visit_if_statement(self, node):
        ...
        for z in node.children:
            ...
            # 这里新加的
                ...
                if node.next_sibling is not None:
                    self.G.add_edge(z.end_point[0] + 1, node.next_sibling.start_point[0] + 1, weight=1)
                    # self.DG.add_edge(z.end_point[0] + 1, node.next_sibling.start_point[0] + 1, weight=1)
                self.ast_visit(z)
            elif z.type == "class_body":
                if node.next_sibling is not None:
                    self.G.add_edge(z.end_point[0] + 1, node.next_sibling.start_point[0] + 1, weight=1)
